...
export const UI_WATCH_OPEN_SOUND = "/assets/music/ui_watch_open.ogg";
export const UI_FRIENDS_OPEN_SOUND = "/assets/music/ui_friends_open.ogg";
export const UI_LEADERBOARD_OPEN_SOUND = "/assets/music/ui_leaderboard_open.ogg";
