...
describe("profile mobile layout contracts", () => {
  it("keeps the mobile profile name under the portrait and all recent results on one row", () => {
    ...
    expect(finalMobileCss).toContain(".user-profile-card .profile-rank-results,");
