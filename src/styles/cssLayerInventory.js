export const CSS_DEBT_BASELINE = {
  ...
  metrics: {
    ...
    importantCount: 7779,
    importantFiles: 310,
    hardcodedHexCount: 2396,
    mediaFiles: 249,
    reducedMotionFiles: 46,
    highZIndexFiles: 7
  },
  featureDeltas: [
    "2026-08-04: registers the bounded mailbox readability redesign. Existing mailbox owners stay at six files and each remains below the 6000-byte guard while the player view gains a text-only low-chrome list, completed-state dimming, quiet paper reader, separate attachment/action placement, quantity and claimed overlays, and a portaled item-detail dialog with desktop and portrait-mobile fitting. The delta uses semantic theme tokens, removes 48 hardcoded hex matches, adds reduced-motion coverage beside the two transitioning owners, adds no breakpoint family or high-z-index debt, and documents the targeted important winners required to beat the established Bright School global button and modal guards.",
