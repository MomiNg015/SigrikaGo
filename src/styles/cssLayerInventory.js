export const CSS_DEBT_BASELINE = {
  ...
  metrics: {
    ...
    mediaFiles: 283,
    reducedMotionFiles: 58,
    highZIndexFiles: 7
  },
  featureDeltas: [
    "Handbook revision restores compact three-column/two-column portrait cards with a hand-painted background, crops the book past its center binding and removes all cover animation. Existing two owners shrink; no new responsive or layering family.",
