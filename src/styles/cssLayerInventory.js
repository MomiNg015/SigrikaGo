export const CSS_DEBT_BASELINE = {
  ...
  metrics: {
    ...
    importantCount: 8878,
    importantFiles: 350,
    hardcodedHexCount: 2354,
    mediaFiles: 280,
    reducedMotionFiles: 58,
    highZIndexFiles: 7
  },
  featureDeltas: [
    "Portrait bookmark leaderboard aligns identity, score/rate and records in reading order; ordinary button labels stay on one line and friend actions wrap whole buttons.",
