export const CSS_DEBT_BASELINE = {
  ...
  featureDeltas: [
    "Portrait battle stationery keeps notebook grids, ink borders, colored controls and paper depth; player-slot overflow preserves the small shadows while skill states override old mobile resets and glow.",
    "Development test actions move to icon-only header controls with a single mobile header row and 44px-high touch targets.",
    "Portrait battle polish adds one scoped final owner for readable actions, restrained active-turn timers and reduced nested chrome; tutorial and corrupted rooms are excluded.",
