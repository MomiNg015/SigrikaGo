...
describe("HomeScreen", () => {
  ...
  it("uses a tactical ID card and skewed navigation cards", () => {
    ...
    expect(brightToolboxEntry).toContain("--utility-x: -6px");
    expect(brightToolboxEntry).toContain("--utility-y: -4px");
    ...
    expect(brightToolboxEntry).toContain("width: 121% !important");
    ...
    expect(brightToolboxEntry).toContain("calc(var(--utility-y, 0px) - 3px)");
    expect(brightToolboxEntry).toContain("calc(var(--utility-tilt, 0deg) + 1.4deg)");
    expect(brightToolboxEntry).toContain("scale(1.015)");
    expect(brightToolboxEntry).toContain("calc(var(--utility-y, 0px) + 1px)");
    expect(brightToolboxEntry).toContain("calc(var(--utility-tilt, 0deg) + 0.7deg)");
