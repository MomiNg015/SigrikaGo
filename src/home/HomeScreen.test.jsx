...
describe("HomeScreen", () => {
  ...
  it("uses a tactical ID card and skewed navigation cards", () => {
    ...
    expect(brightPlaqueBlock).toContain("grid-template-columns: 72px minmax(0, 1fr) minmax(122px, 136px)");
    ...
    expect(brightNarrowDesktopMedia).toContain("grid-template-columns: 62px minmax(0, 1fr) minmax(100px, clamp(104px, 28%, 120px))");
  ...
  it("keeps the HUD footer minimal and rewrites the mobile lobby layout", () => {
    ...
    expect(finalMobileCss).toContain("grid-template-columns: 62px minmax(0, 1fr) minmax(118px, 132px) !important");
    ...
    expect(finalMobileCss).toContain("grid-template-columns: clamp(54px, 7vw, 64px) minmax(0, 1fr) minmax(108px, 30%) !important");
