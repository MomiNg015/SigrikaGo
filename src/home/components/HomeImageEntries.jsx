export function HouseManualEntry({ onOpenHouse }) {
  return (
    <button className="home-image-entry house-manual-entry hologram-entry" data-hud="DIARY_LOG (｡•̀ᴗ- )✧" onClick={onOpenHouse} aria-label="部员手册">
...
export function MatchEntry({ matchmakingCount, onStartMatch }) {
  return (
    <section className="home-match-feature" aria-label="空想对局入口">
      <button className="home-image-entry match-image-entry hologram-entry" data-hud="MATCH_READY!! ✦" onClick={onStartMatch} aria-describedby="matchmaking-count-popup">
