...
- `src/styles/themeContract.test.js` owns the Bright School base, contrast-purge, home, commerce, modals, mobile, mobile room, component repair, quality-base, and firewall import order.
