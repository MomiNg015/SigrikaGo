...
- `src/styles/styleContract.test.js` also owns the `mobile-adaptive.css` import order plus the nested `home-narrow-desktop.css`, `bright-school-overrides.css`, `bright-school-overrides/profile-house-records.css`, and `bright-school-portrait.css` import orders because these entries are the final safety layers after theme imports.
- `src/styles/themeContract.test.js` owns the Bright School base, contrast-purge, radical-purge, specificity-overrides, home, gallery-polish, commerce, modals, effects, room, mobile, mobile house/profile, mobile room, component repair, quality-base, and firewall import order.
