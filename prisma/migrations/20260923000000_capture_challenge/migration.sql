CREATE TABLE IF NOT EXISTS "CaptureChallengeBest" (
...
CREATE INDEX IF NOT EXISTS "CaptureChallengeBest_captures_idx" ON "CaptureChallengeBest"("captures");
CREATE TABLE IF NOT EXISTS "CaptureChallengeResult" (
...
CREATE INDEX IF NOT EXISTS "CaptureChallengeResult_userId_idx" ON "CaptureChallengeResult"("userId");
