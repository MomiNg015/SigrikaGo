...
- Mobile character-detail dialogs keep the character name horizontal and single-line, place the compact BGM preview capsule at the top-right of the heading row, and left-align skill and character-description copy; Bright School theme layers and the final `mobile-adaptive` safety layer repeat these constraints so narrow phones cannot fall back to vertical names or centered body text.
